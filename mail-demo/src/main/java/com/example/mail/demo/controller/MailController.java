...
public class MailController {
    ...
    public String sendSimpleMail() {
        ...
        msg.setFrom("1622504316@qq.com");
        msg.setSentDate(new Date());
        msg.setTo("1622504316@qq.com");
    ...
    public String sendFileMail() throws MessagingException {
        ...
        helper.setFrom("1622504316@qq.com");
        helper.setSentDate(new Date());
        helper.setTo("1622504316@qq.com");
        helper.addAttachment("img1.jpg", new File("C:\\Users\\ASUS\\Desktop\\茗茗\\绘画\\二次元Q版人物\\img1.jpg"));
        helper.addAttachment("img2.jpg", new File("C:\\Users\\ASUS\\Desktop\\茗茗\\绘画\\二次元Q版人物\\img2.jpg"));
        javaMailSender.send(msg);
        return "发送成功";
    }
    @GetMapping("/image")
    public String sendImageMail() throws MessagingException {
        ...
        helper.setSentDate(new Date());
        helper.setTo("1622504316@qq.com");
        helper.addInline("a1", new FileSystemResource("C:\\Users\\ASUS\\Desktop\\茗茗\\绘画\\二次元Q版人物\\img1.jpg"));
        javaMailSender.send(msg);
        return "发送成功";
    }
