package com.example.res.custom.demo.controller;

import com.example.res.custom.demo.common.ExceptionType;
import com.example.res.custom.demo.exception.CustomException;
...
public class FileController {
    ...
    public ResponseEntity<byte[]> fileDownload(@PathVariable String filename,
        ...
        try {
            ...
            headers.add("Cache-Cntrol","no-cache,no-store,must-revailidate");
...
//            headers.setContentType(MediaType.APPLICATION_OCTET_STREAM);
            return new ResponseEntity<>(FileUtils.
